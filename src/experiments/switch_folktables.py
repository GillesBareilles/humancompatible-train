...
if __name__ == "__main__":
    ...
    for EXP_IDX in range(EXP_NUM):
        ...
        random_seed = EXP_IDX
        history = SwitchingSubgradient_unbiased(net, train_ds, w_ind=w_idx_train, b_ind = nw_idx_train, loss_bound=LOSS_BOUND,
    ...
    full_stats.to_csv(os.path.join(utils_path, f'{ALG_NAME}_{DATASET_NAME}_{LOSS_BOUND}_REPORT.csv'))